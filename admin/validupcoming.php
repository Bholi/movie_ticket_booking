...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO upcoming(movie_name, production, genre, imdb, platform, date, language, director, movie_desc, image,trailer) VALUES ('$mv_name','$production','$genre','$imdb','$platform','$mv_date','$mv_lang','$mv_direct','$mv_desc','$img','$mv_trailer')";
