...
<body>
    <div class="container">
        <form action="validupcoming.php" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" name="trailer" placeholder="Enter trailer code"><br>
            <input type="submit" class="btn btn1" name="submit" value="Add Upcoming Movie">
        </form>
    </div>
</body>
</html>