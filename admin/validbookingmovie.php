...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO booking(name, production, genre, imdb, platform, date, language, director, description, image, trailer, category) VALUES ('$mv_name','$production','$genre','$imdb','$platform','$mv_date','$mv_lang','$mv_direct','$mv_desc','$img','$mv_trailer','$c_id')";
